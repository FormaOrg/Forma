...
class ProjectStorefrontServiceTest {
    ...
    void getStorefrontCreatesDefaultDraftForOwnedEcommerceProject() {
        ...
        assertThat(storefront.getDraftHomepage().get("sections")).hasSize(4);
    }
    ...
    void updateAndPublishStorefrontPersistDraftAndPublishedContent() throws Exception {
        ...
        assertThat(updated.getDraftHomepage().get("seo").get("title").asText()).isEqualTo("Updated shop");
        ...
        assertThat(published.getStorefront().getPublishedHomepage().get("seo").get("title").asText()).isEqualTo("Updated shop");
