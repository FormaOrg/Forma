...
public class ProjectCollaboratorService {
    ...
    public ProjectCollaboratorDto inviteCollaborator(String ownerEmail, Long projectId, InviteCollaboratorRequest request) {
        ...
        afterCommitExecutor.execute(() -> collaboratorEmailService.sendCollaboratorInviteEmail(
                inviteEmail,
                ownerName,
                project.getName(),
    ...
    public Optional<ProjectCollaboratorDto> getMyPendingInvitation(String email, Long projectId) {
        ...
        return collaboratorRepository.findByProjectIdAndInviteEmail(projectId, normalizedEmail)
                .filter(collaborator -> collaborator.getStatus() == CollaboratorStatus.PENDING)
                .map(this::mapToDto);
    }
    ...
    private ProjectCollaboratorDto mapToDto(ProjectCollaborator collaborator) {
        User invitee = collaborator.getUser();
        return ProjectCollaboratorDto.builder()
                .id(collaborator.getId())
                .projectId(collaborator.getProject().getId())
                .userId(invitee != null ? invitee.getId() : null)
                .inviteEmail(collaborator.getInviteEmail())
                .role(collaborator.getRole())
                .status(collaborator.getStatus())
                .invitedAt(Objects.toString(collaborator.getInvitedAt(), null))
                .acceptedAt(Objects.toString(collaborator.getAcceptedAt(), null))
                .userName(invitee != null ? buildFullName(invitee) : null)
                .userAvatarUrl(invitee != null ? invitee.getAvatarUrl() : null)
                .invitationToken(collaborator.getStatus() == CollaboratorStatus.PENDING ? collaborator.getInvitationToken() : null)
                .build();
    }
